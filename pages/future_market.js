                                    ...
                                    <div>
                                        <div className="info">
                                            ...
                                            <div className="summary col-md-6">
                                                ...
                                                <p>따라서, 귀사가 {store.storedWishYear}년 뒤에 ${store.storedWishMoney}를 수취하게 되는 경우, 선물환 매도를 하게 되면 환율 변동과 상관없이 안정적으로 {store.storedFetchData.krwLoanTN}를 수취할 수 있게 됩니다.</p>
