                                        ...
                                        <div className="info">
                                            ...
                                            <div className="row">
                                                ...
                                                <div className="summary col-md-6">
                                                    ...
                                                    <p>따라서, 귀사가 {store.storedWishYear}년 뒤에 ${store.storedWishMoney}를 수취하게 되는 경우, 달러화 차입 + 현물환 매도 + 원화 대출을 하게 되면 환율 변동과 상관없이 안정적으로 ￦{store.storedFetchData.sumOfMarket}를 수취할 수 있게 됩니다.</p>
