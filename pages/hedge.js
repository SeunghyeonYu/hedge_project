                        ...
                        <div className="row justify-content-center">
                            <div className="col-md-5 col-lg-4">
                                <div className="clean-pricing-item">
                                    ...
                                    <p>asdfasdfasdfasdfasdfasdfasdfasdfasdfasdfasdfasdfasdfasdfas.</p>
                                    <div className="price">
                                        <h4>($25)</h4>
                                    </div><button className="btn btn-outline-primary btn-block" type="button">상세 이동</button>
                                </div>
                            </div>
                            <div className="col-md-5 col-lg-4">
                                <div className="clean-pricing-item">
                                    ...
                                    <div className="price">
                                        <h4>($500)</h4>
                                    </div><button className="btn btn-primary btn-block" type="button">상세 이동</button>
                                </div>
                            </div>
                            <div className="col-md-5 col-lg-4">
                                <div className="clean-pricing-item">
